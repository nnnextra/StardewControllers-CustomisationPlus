...
## [1.1.10-prerelease.12] - 2025-12-25

### Changed

- Actions/Mods help text now shows just the button icon with no extra wording.

## [1.1.10-prerelease.11] - 2025-12-25

### Fixed

- Cancel in the wheel repositioning window now truly reverts the wheel position, even if you later save the config.

## [1.1.10-prerelease.10] - 2025-12-25

### Fixed

- Cancel on reposition now never saves the new position.

---

## [1.1.10-prerelease.9] - 2025-12-25

### Fixed

- Canceling reposition now persists even if you later save via other paths.
